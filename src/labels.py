...
def get_category(score):
    ...
    elif score <= 150: return 2
    elif score <= 400: return 3
...
def main():
    ...
    parser.add_argument("--input_dir", type=str, required=True, help="Path to directory containing raw 1-min CSV files")
    parser.add_argument("--output_file", type=str, required=True, help="Path to output labels CSV file")
