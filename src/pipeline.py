...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, help="Path to a directory of raw CSV files")
    parser.add_argument("--output_dir", type=str, help="Path to a directory to save processed CSV files")
