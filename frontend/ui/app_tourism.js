...
function showReasonPopover(anchorEl, ds, k) {
  ...
  if (cat >= 4) {
    ...
    tourEl.className = 'reason-popover__confidence premium-tip';
    ...
    tourEl.style.flexDirection = 'column';
    tourEl.style.alignItems = 'flex-start';
    tourEl.innerHTML = '<span style="font-size:10px;">' + tourTitle + '</span><span style="font-weight:bold; font-size:12px; margin-top: 2px;">' + tourText + '</span>';
