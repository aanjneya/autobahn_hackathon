...
function showReasonPopover(anchorEl, ds, k) {
  ...
  if (cat > 0) {
    ...
    logEl.className = 'reason-popover__confidence premium-tip';
    ...
    logEl.innerHTML = '<span style="font-size:10px;">' + logTitle + '</span><span style="font-weight:bold; font-size:12px; margin-top: 2px;">' + delayMap[cat] + '</span>';
